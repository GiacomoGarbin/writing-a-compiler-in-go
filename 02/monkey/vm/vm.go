...
func (vm *VM) executeBinaryOperation(op code.Opcode) error {
	...
	default:
		return fmt.Errorf("unsopported types for binary operation: %s %s", leftType, rightType)
	}
}
...
func (vm *VM) executeCall(numArgs int) error {
	...
	default:
		return fmt.Errorf("calling non-function and non-built-it")
	}
}
